...
- Se hace la diferencia entre el mayor y el menor
- 56 - (-53) = 56 + 53 = 109
- Rta: Hay 109 grados de diferencia
...
1. Parte en el piso **0**.
2. **Sube 5** → está en piso **+5**
3. **Baja 8** → 5 − 8 = **−3**
4. **Sube 3** → −3 + 3 = **0**
5. **Baja 7** → 0 − 7 = **−7**
6. **Sube 10** → −7 + 10 = **+3**
...
**a)** Termina en el piso **−1**.

**b)** Pisos recorridos:
Sumamos el valor absoluto de cada movimiento:
|5| + |−8| + |3| + |−7| + |10| + |−4| = 5 + 8 + 3 + 7 + 10 + 4 = **37 pisos en total**

**c)** Recta numérica (simplificada):
...
(Este punto se puede hacer gráficamente con una recta, marcando cada parada.)

**d)** ¿Cuántas veces pasó por el nivel 0?

* Parte en 0
* Lo vuelve a cruzar al subir de −3 a 0
  → **Pasó por el nivel 0 dos veces**
